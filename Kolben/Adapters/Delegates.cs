...
namespace Kolben.Adapters
{
    ...
    /// <param name="moduleName">The API class's name.</param>
    /// <param name="memberName">The name of the member.</param>
    /// <returns>If the member exists.</returns>
    public delegate bool DHasMember(ScriptProcessor processor, string moduleName, string memberName);
    ...
    public delegate SObject DGetMember(ScriptProcessor processor, string moduleName, SObject accessor, bool isIndexer);
    ...
    public delegate SObject DExecuteMethod(ScriptProcessor processor, string moduleName, string methodName, SObject[] parameters);
    ...
    public delegate void DSetMember(ScriptProcessor processor, string moduleName, SObject accessor, bool isIndexer, SObject value);
